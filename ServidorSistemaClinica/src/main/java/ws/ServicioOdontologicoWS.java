...
public class ServicioOdontologicoWS {
    ...
    public boolean crears(@WebParam(name = "servicioodontologico") ServicioOdontologico servicioodontologico) {
        boolean aux=true;
        try
        {
    ...
    public boolean edits(@WebParam(name = "servicioodontologico") ServicioOdontologico servicioodontologico) {
    ...
    public ServicioOdontologico finds(@WebParam(name = "id") int id) {
        //TODO write your implementation code here:
